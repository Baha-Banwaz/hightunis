  ...
  return (
    <div className="bg-white text-black min-h-screen flex flex-col">
      <div className="flex-grow max-w-[1600px] w-full mx-auto px-6 lg:px-12 pt-32 pb-24">
        <p className="text-[10px] font-bold uppercase tracking-[3px] text-black/60 mb-8">Error 500</p>
        ...
        {error.digest && (
          <p className="text-[10px] font-bold uppercase tracking-[3px] text-black/60 mb-16">
